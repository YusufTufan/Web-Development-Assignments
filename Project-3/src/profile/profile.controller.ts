...
export class ProfileController {
  ...
  async create(
    ...
    const photoUrl = `${process.env.BASE_URL || 'http://localhost:3000'}/public/photos/${file.filename}`;
  ...
  update(
    ...
    if (file) {
      photoUrl = `${process.env.BASE_URL || 'http://localhost:3000'}/public/photos/${file.filename}`;
    }
